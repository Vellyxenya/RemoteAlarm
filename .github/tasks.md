...
- Phase 0 — Setup
	...
	- Task 0.2: Configure Authentication
		- Enable Anonymous Auth (fastest for MVP)
		- Later: upgrade to Google sign-in or custom auth if needed
		- Goal: Only authenticated users can upload audio
	- Task 0.3: Lock Down Storage Rules
		- Set Firebase Storage rules:
			...
			```
		- Goal: Nobody can download audio directly from Storage
